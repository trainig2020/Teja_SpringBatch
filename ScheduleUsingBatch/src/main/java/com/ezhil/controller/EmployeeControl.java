...
import com.ezhil.config.JobConfig;
...
public class EmployeeControl {
	...
	public ModelAndView autoScheduling() throws Exception {
		...
		Directory folder = new Directory("C:\\Users\\EZHILARASI\\Documents\\CSV");
		Directory folderCopy = new Directory("C:\\Users\\EZHILARASI\\Documents\\DestCSV");
		try {
	...
	public ModelAndView manualmodeSch(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int i=0;
			try {
				Resource[] resources = resolver.getResources("file:C:/Users/EZHILARASI/Documents/CSV/*.csv" );
